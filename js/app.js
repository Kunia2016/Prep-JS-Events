...
window.onload = function benjamin(){
document.getElementById("lines").addEventListener = "lines";
...
//.innerHTML = "Our lives are defined by opportunities; even the ones we miss.";
...
{product: "Chewbacca Mask", price: 3.41}, {product: "Woof Washer 360", price: 9.99}, 
{product: "Sauna Pants", price: 39.95}];

function finalBoss(p){
  for (var x =0; x<orders.length; x++);
var myOrders = document.createElement("p");
}
  
document.getElementById("finalBoss").innerHTML=myOrders;
document.getElementById("finalBoss").addEventListener("click", myOrders);*/
